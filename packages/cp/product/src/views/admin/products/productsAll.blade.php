        ...
        <div class="col-md-11 mx-auto">
            <div class="card mb-2 shadow-lg">
                <div class="card-header px-2 py-2">
                    ...
                    class="fas fa-sitemap text-primary"></i> Products </h3>
                    <div class="card-tools w3-small">
                        <a href="{{ route('admin.productCreate')}}" class="btn-create-from btn btn-outline-primary btn-xs pull-right mr-2 py-1"><i class="fas fa-plus-square"></i> Add New Product</a>
                    </div>
                </div>
            </div>
                ...
                <div class="card-header pl-2 py-2">
                    ...
                    <div class="card-tools">
                        <div class="input-group input-group-sm">
                            <input type="search" name="q" class="product-search form-control border-right-0 border py-2" data-url="{{ route('admin.productSearch' , ['type' => 'product']) }}"  placeholder="Search name, price, id...">
                ...
                <div class="card-body bg-light px-0 pb-0 pt-2">
                    <div class="col-sm-12">
                        <div class="table-responsive table-responsive-sm data-container">
                            @include('product::admin.products.searchData')
                        </div>
