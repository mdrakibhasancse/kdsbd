        ...
        <div class="col-md-8 mx-auto">
            <div class="card mb-2 shadow-lg">
                <div class="card-header px-2 py-2">
                    ...
                    class="fas fa-plus-circle text-primary"></i> Add New SubCategory</h3>
            ...
            <div class="card card-primary card-outline w3-round mb-2 shadow-lg">
                <div class="card-body px-3 py-1 w3-light-gray">
                    <form class="" action="{{route('admin.productSubCategoryStore')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
