...
<div id="modal_register" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-dialog-centered modal-lg " role="document" style="width: 385px;">
    <div class="modal-content border-0"  style="background:rgba(99, 97, 97, 0.4);">
              ...
              <div class="card">
                  <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="code" name="code" class="form-control "value="{{ old('code')}}" placeholder="Enter code">
                    </div>
                    <button type="submit" class="btn btn-sm btn-block btn-primary btn-first-next py-3">{{ __('Check Otp') }}</button>
                  </div>
              </div>
          </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" id="mobile" name="mobile"  class="form-control input-mobile @error('mobile') is-invalid @enderror" value="{{ old('mobile')}}" placeholder="Enter Mobile">
                    ...
                    <button type="submit" class="btn btn-sm btn-block btn-primary btn-first-next py-3">{{ __('Next') }}</button>
                    </div>
                </div>
            </div>
            </div>
