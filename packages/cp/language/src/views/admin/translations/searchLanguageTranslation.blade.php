    ...
    <tbody>
        @foreach ($lang_keys as $key => $translation)
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control value" style="width:100%" name="values[{{ $translation->lang_key }}]" @if (($traslate_lang = Cp\Language\Models\LanguageTranslation::where('lang', $language->language_code)->where('lang_key', $translation->lang_key)->latest()->first()) != null)
